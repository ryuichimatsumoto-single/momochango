...
// 検索欄に日付が入力されているとき
    // SQLからの検索結果を配列に格納する
    $monthly_data = sqlQueries::get_latest_temperature(100);
...
<div class="row marketing">
    ...
    <script>
      ...
      $(document).ready(function()
      {
          ...
          weight_data = <?php echo get_graph_data($monthly_data,"temperature");?>;

          //  体重のグラグ
          graph_weight = $.jqplot( 'jqPlot-temperature', [weight_data],
          {
